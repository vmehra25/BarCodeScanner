...
//                    Toast.makeText(this@BarCodeActivity, "Image Saved", Toast.LENGTH_LONG).show()
...
//                    Toast.makeText(this@BarCodeActivity, "Error Image not saved", Toast.LENGTH_LONG).show()
//                    Log.e("CAM", "ImageCapture onError = $exception")
//                }
//
//            }
//        )
...
//        val fileName = "GoogleLensClone" + File.separator + displayName + ".jpg"
//        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q){
...
//            val photoDir = File(dir, "GoogleLensClone")
//            if(!photoDir.exists()){
//                photoDir.mkdirs()
//            }
